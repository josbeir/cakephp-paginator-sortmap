 ...
 */
namespace Josbeir\Test\TestCase\Datasource;
...
class PaginatorTest extends TestCase
{
     ...
     * @return void
     */
    public function testValidatesortMapFailure()
    {
     ...
     * @return void
     */
    public function testValidatesortMapTrusted()
    {
        $model = $this->mockAliasHasFieldModel();
     ...
     * @return void
     */
    public function testValidatesortMapMap()
    {
        $model = $this->mockAliasHasFieldModel();
     ...
     * @return void
     */
    public function testValidatesortMapEmpty()
    {
        $model = $this->mockAliasHasFieldModel();
     ...
     * @return void
     */
    public function testValidatesortMapNotInSchema()
    {
        $model = $this->getMockRepository();
        $model->expects($this->any())
            ->method('getAlias')
     ...
     * @return void
     */
    public function testValidatesortMapMultiple()
    {
        $model = $this->mockAliasHasFieldModel();
